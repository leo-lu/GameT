...
cc.exports.CustomResultCode = {
    kCustomExtension = 80000 --enum value is  extension code .
}--custom result code


-- for ads
cc.exports.AdsResultCode = {
...
cc.exports.PushActionResultCode = {
...
cc.exports.UserActionResultCode = {
...
cc.exports.AccountOperate = {
    LOGIN       = 0,
    LOGOUT      = 1,
    REGISTER    = 2
}

cc.exports.AccountGender = {
    MALE       = 0,
    FEMALE     = 1,
    UNKNOWN    = 2
}
